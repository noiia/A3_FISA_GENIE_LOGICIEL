...
public class RealTimeState
{
    ...
    public static void WriteState(string SaveJobName, bool IsActive, Counters counter, FileInfo fileInfo, string destinationPathDir, string fileName, string msg)
    {
        ...
        if (!header)
        {
            ...
            {
                string isActive = IsActive ? "Active" : "Not Active";
