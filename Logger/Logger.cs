...
public static class LoggerUtility
{
    ...
    public static string LogPath { get; set; } = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
    ...
    public static void WriteLog(string logFileType, string type, string msg)
    {
        ...
        try
        {
            switch (logFileType)
            {
                ...
                case "xml":
                {
                    var serializer = new XmlSerializer(typeof(LogStructure));
